...
?>
<!doctype html><html><head><title>Categories</title>
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/4.6.0/css/bootstrap.min.css">
</head><body><div class="container mt-4">
<h2>Categories <a class="btn btn-sm btn-primary" href="create.php">Add</a> <a class="btn btn-sm btn-secondary" href="../index.php">Back</a></h2>
<table class="table table-bordered">
<tr><th>ID</th><th>Category</th><th>Actions</th></tr>
