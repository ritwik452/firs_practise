...
<div class="container">
  <div class="card">
    <div class="card-header">
      <div class="title">Comments Management</div>
      <div class="actions">
        <input id="commentSearch" class="search" placeholder="Search comment..." />
        ...
        <tbody id="commentTable">
          <?php
            $query = "SELECT 
                ...
                JOIN users a ON a.id = books.author_id           
          ...
          <tr>
            ...
            <td><?php echo htmlspecialchars(substr($row['comment'],0,80)); ?>...</td>
