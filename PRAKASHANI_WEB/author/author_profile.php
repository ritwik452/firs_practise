...
$query = "SELECT * FROM users WHERE id='$author_id' AND role='author'";
...
<?php
    ...
    $profile_path = '../uploads/cover/';
    $profile_file = $row['profile_photo'];

    if (!empty($profile_file) && file_exists($profile_path . $profile_file)) {
        $img = $profile_path . $profile_file;
    } else {
        $img = 'https://cdn-icons-png.flaticon.com/512/149/149071.png';
    }
?>

<img src="<?php echo $img; ?>" class="avatar" alt="Profile Photo">
